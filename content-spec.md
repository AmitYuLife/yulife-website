# Website — Content & Layout Spec

> Source: [Website content doc](https://docs.google.com/document/d/1fd3c4buivd3VktGoYOsU4ebDnI6wEa5KPpOcrU7GBwc/edit?tab=t.806q2oeua2xz#heading=h.h5j72k1lbv5c)
> Purpose: section-by-section content & layout brief covering every **populated** page in the content doc. Copy is preserved verbatim (cleaned of doc formatting artefacts and internal editorial notes). Layout/component notes are recommendations, not final copy decisions.
...
- **Layout** = recommended structure (columns, grid, alignment) for the page.
...
🟦 *Recommended stub:* Logo · Products · Who We Serve · Resources · About · **[Request a demo]** (primary button). Sticky on scroll. **[U/B]**
...
🟦 *Note:* Source references League's 2×2 home-page treatment as a reference ([https://league.com/](https://league.com/)). **[B]**
...
5. ⚠️ **Section labels** — source uses internal labels ("Section 3", "Section 6"). These are not display copy; omit from the page.
