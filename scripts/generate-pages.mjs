...
// record up from the sitemap data and renders the minimal <SimpleHero>
// placeholder (the grey-box PageStub/wireframe templates were retired).
//
...
for (const t of targets) {
  ...
  await writeFile(filePath, template(t.route), "utf8");
  count++;
